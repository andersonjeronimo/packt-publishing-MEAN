angular.module('angularApp').directive('progressBar', function ($timeout, $interval) {
  return {
    ...
    replace: false,
    transclude: true,
    templateUrl: 'app/views/barra-progresso.html',
    scope: {
      diversao: '='
    },
    controller: function ($scope) {
      ...
      var updateProgressBar = function () {
        if ($scope.diversao.iniciada) {
          ...
          var agora = new Date().getMilliseconds();
          ...
          //tempo_restante.setHours((tempo_restante_millis / hora_millis), (tempo_restante_millis / minuto_millis));
